        ...
        <div className="rounded-3xl bg-zinc-900/60 backdrop-blur-xl border border-white/10 p-8 shadow-xl">
          <div className="space-y-6 text-sm text-zinc-400 leading-relaxed">
            ...
            <section>
              ...
              <p>Vous pouvez demander l'accès, la rectification ou la suppression de vos données. Contact: <a className="text-gold-primary hover:text-amber-300 transition-colors" href="mailto:support@scim.app">support@scim.app</a></p>
            </section>
          </div>
